...
UINT8X mainKeyMap[40][2]={
    ...
    {0,KEY_APOSTROPHE}, {0,KEY_DOT}, {0,KEY_B}, {0,KEY_N}, {0,KEY_M}, {2,KEY_SLASH}, {0,KEY_UP}, {0,KEY_RIGHTSHIFT}, 
...
UINT8X Fn0_keyMap[40][2]={
    ...
    {0,KEY_APOSTROPHE}, {0,KEY_DOT}, {0,KEY_B}, {2,KEY_LEFTBRACE}, {2,KEY_RIGHTBRACE}, {2,KEY_SLASH}, {0,KEY_UP}, {0,KEY_RIGHTSHIFT}, 
    {2,KEY_5}, {0,KEY_SLASH}, {0,KEY_SPACE}, {0,KEY_SLASH}, {KEY_FnX,0}, {0,KEY_LEFT}, {0,KEY_DOWN}, {0,KEY_RIGHT},
};
